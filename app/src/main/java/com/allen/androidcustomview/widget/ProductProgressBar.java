...
public class ProductProgressBar extends View {
    ...
    private void init() {
        ...
        progressHeight = dp2px(30);
        roundRectRadius = dp2px(10);
...
//        canvas.drawCircle(width, getHeight() / 2, 100, progressPaint);
//        canvas.drawCircle(width * 2, getHeight() / 2, 100, progressPaint);
//        canvas.drawCircle(width * 3, getHeight() / 2, 100, progressPaint);
    }
    ...
    public ProductProgressBar setProgress(float progress, float total) {
        mProgress = progress;
        this.total = total;
        initAnimation();
        return this;
